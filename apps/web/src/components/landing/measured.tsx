  ...
  return (
    <Section className="rule-t py-16 lg:py-24">
      <Reveal>
        ...
        <h2 className="display max-w-[22ch] text-3xl text-ink md:text-[2.75rem]">
      ...
      <Reveal delay={0.1}>
        ...
        {/*
         * Out to the generated document rather than to a page in this app.
         *
         * There used to be a `/fidelity` route rendering these rows in a browsable explorer.
         * It was removed because nobody arrived at it with a task: the numbers matter as
         * evidence for the claims made here, and as evidence they belong next to the claims,
         * not behind a second click into a table with no verb attached to it. `FIDELITY.md`
         * is generated by the same run that writes `baselines.json`, so this link and the
         * figures above cannot disagree.
         */}
        <a
          href={DOCS.fidelity}
          target="_blank"
          rel="noreferrer noopener"
          className="mt-10 inline-flex items-center gap-2 text-[13px] text-accent underline-offset-4 hover:underline"
        >
...
function Outlier({
  ...
  return (
    <div>
      <div className="font-mono text-4xl tabular-nums tracking-tight text-accent">{value}</div>
