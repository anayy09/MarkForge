...
| agentify/dedup/retention-policy.md | authored | Apache-2.0 | MarkForge | — | §2.16. The fresh §10.4 grading set, authored 2026-08-01 after the §2.14.1 predicate. Holds one side of the recall pair and one side of each hard negative |
| agentify/dedup/platform-guide.md | authored | Apache-2.0 | MarkForge | — | §2.16. The other side. Restates the 64 MB ceiling with almost no shared vocabulary (the recall case) and states the ordering and retention obligations differently (the hard negatives) |
| agentify/dedup/expected-units.json | authored | Apache-2.0 | MarkForge | — | §2.16 answer key. Records the expected merge verdicts and why, under §2.14.1 |
